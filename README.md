...
Le projet a été initié sur [Lovable](https://lovable.dev) — d'où le dossier `.lovable/` et `AGENTS.md`. Ça reste synchronisé avec Lovable en plus d'être sur GitHub, donc évite de force-push ou de réécrire l'historique sur la branche `main`.
